...
import { Trash2, ArrowLeft, ShoppingBag, CheckCircle, Calendar, X, MapPin, Heart, Tag, AlertCircle, ChevronLeft, ChevronRight, Truck, Home } from 'lucide-react';
import { OfferType, MarketType } from '../../types';

export const ShoppingCart: React.FC = () => {
  const { cart, removeFromCart, placeOrder, user, clearCart, clients, moveToFavorites, validateCoupon, producers, pickupPoints } = useStore();
