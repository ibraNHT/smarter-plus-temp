...
import { ArrowLeft, ShoppingCart, MessageCircle, MapPin, ShieldCheck, Package, Plus, Minus, User, Lock, Truck, AlertCircle, Calendar, Clock, Star, Image as ImageIcon, PlayCircle, ChevronLeft, ChevronRight, X, Heart, Layers } from 'lucide-react';
            ...
            <div className="md:w-1/2 h-96 md:h-auto relative bg-gray-200">
              ...
              <div className="absolute top-4 left-4 flex flex-col gap-2">
                <span className={`inline-flex items-center px-3 py-1 rounded-full text-xs font-bold shadow-sm ${
                  isProducerMarket ? 'bg-green-100 text-green-800' : 'bg-blue-100 text-blue-800'
                }`}>
