  ...
  const paymentFormik = useFormik({
    ...
    validate: (values) => {
      const parsed = z.object({
        ...
        accountNumber: z.string().trim().min(3, t('profile.accountNumberRequired')),
        accountName: z.string().trim().min(2, t('profile.accountNameRequired')),
      }).superRefine((val, ctx) => {
