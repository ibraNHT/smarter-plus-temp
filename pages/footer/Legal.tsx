  ...
  return (
    <div className="bg-gray-50 min-h-screen py-8 sm:py-12 md:py-16">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center mb-6 sm:mb-8 border-b border-gray-200 pb-4 sm:pb-6 gap-3 sm:gap-4">
           <FileText className="h-8 w-8 sm:h-10 sm:w-10 text-gray-400 flex-shrink-0" />
           <h1 className="text-2xl sm:text-3xl font-bold text-gray-900">{t('terms.title')}</h1>
        </div>
        
        <div className="prose prose-blue max-w-none text-gray-600 space-y-4 sm:space-y-6 text-sm sm:text-base">
           ...
           <h3 className="text-lg sm:text-xl font-bold text-gray-800">1. User Accounts</h3>
           ...
           <h3 className="text-lg sm:text-xl font-bold text-gray-800">2. Marketplace Transactions</h3>
           ...
           <h3 className="text-lg sm:text-xl font-bold text-gray-800">3. Payments & Fees</h3>
           ...
           <h3 className="text-lg sm:text-xl font-bold text-gray-800">4. Prohibited Conduct</h3>
  ...
  return (
    <div className="bg-gray-50 min-h-screen py-8 sm:py-12 md:py-16">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-white p-5 sm:p-8 md:p-12 rounded-lg shadow-sm">
        <div className="flex items-center mb-6 sm:mb-8 border-b border-gray-200 pb-4 sm:pb-6 gap-3 sm:gap-4">
           <Shield className="h-8 w-8 sm:h-10 sm:w-10 text-green-600 flex-shrink-0" />
           <h1 className="text-2xl sm:text-3xl font-bold text-gray-900">{t('privacy.title')}</h1>
        </div>
        
        <div className="prose prose-green max-w-none text-gray-600 space-y-4 sm:space-y-6 text-sm sm:text-base">
           ...
           <h3 className="text-lg sm:text-xl font-bold text-gray-800">1. Information Collection</h3>
           ...
           <h3 className="text-lg sm:text-xl font-bold text-gray-800">2. Data Usage</h3>
           ...
           <h3 className="text-lg sm:text-xl font-bold text-gray-800">3. Data Sharing</h3>
           ...
           <h3 className="text-lg sm:text-xl font-bold text-gray-800">4. Security</h3>
