...
const translations: Record<string, Record<Language, string>> = {
  ...
  'order.requestCancellationHint': { en: 'This order is already paid. An administrator must approve the cancellation before it is refunded.', fr: 'Cette commande est déjà payée. Un administrateur doit approuver l’annulation avant le remboursement.' },
