...
const translations: Record<string, Record<Language, string>> = {
  ...
  'chat.serviceListedRate': { en: 'Listed rate: {price} XAF per {unit}', fr: 'Tarif affiché : {price} XAF par {unit}' },
  'chat.serviceRateRange': { en: 'Propose between {min} and {max} XAF per {unit}', fr: 'Proposez entre {min} et {max} XAF par {unit}' },
  'chat.serviceRateUpTo': { en: 'Propose up to {max} XAF per {unit}', fr: 'Proposez jusqu’à {max} XAF par {unit}' },
  'chat.productRateRange': { en: 'Allowed range: {min} – {max} XAF per unit', fr: 'Fourchette autorisée : {min} – {max} XAF par unité' },
  'chat.productRateUpTo': { en: 'Propose up to {max} XAF per unit', fr: 'Proposez jusqu’à {max} XAF par unité' },
